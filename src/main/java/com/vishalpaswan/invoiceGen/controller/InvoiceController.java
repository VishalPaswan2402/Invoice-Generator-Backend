...
import com.vishalpaswan.invoiceGen.service.invoiceService.InvoiceService;
...
public class InvoiceController {
    ...
    public ResponseEntity<?> saveNewInvoice(
            @Valid @RequestBody InvoiceRequest invoiceRequest,
            @PathVariable String companyOwnerId,
    ...
    public ResponseEntity<?> deleteInvoiceById(
            @PathVariable String invoiceId,
            @PathVariable String ownerId,
            @RequestHeader("Authorization") String authHeader
    ) {
    ...
    public ResponseEntity<?> updateInvoice(
            @Valid @RequestBody InvoiceRequest newInvoice,
            @PathVariable String ownerId,
            @PathVariable String invoiceId,
            @RequestHeader("Authorization") String authHeader
    ) {
