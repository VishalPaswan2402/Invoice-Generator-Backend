...
public class OtpMailTemplate {
    ...
    private void sendOtp(String sender, String receiver, String otp) throws MessagingException {
    ...
    public void sendYourOtp(String sender, String receiver, String otp) throws MessagingException {
        sendOtp(sender, receiver, otp);
    }
}
