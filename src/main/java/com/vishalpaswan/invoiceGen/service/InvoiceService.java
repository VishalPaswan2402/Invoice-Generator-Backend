...
public class InvoiceService {
    ...
    public ResponseEntity<?> sendInvoiceLinkOnMail(String ownerId, String invoiceId) {
        ...
        try {
            ...
            sendEmailService.sendInvoiceLinkMail(company.getEmail(), invoice.getBillingDetails().getEmail(), invoiceUrl, company.getCompanyName());
            ...
            mailQueueImp.addFailedMailToQueue(mailQueueItems);
